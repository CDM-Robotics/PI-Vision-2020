...
public final class Main {
  ...
  public static boolean readSwitchedCameraConfig(JsonObject config) {
    ...
    JsonElement nameElement = config.get("name");
    if (nameElement == null) {
      mLog.error("could not read switched camera name");
      return false;
    }
    cam.name = nameElement.getAsString();
    ...
    if (keyElement == null) {
      mLog.error("switched camera '" + cam.name + "': could not read key");
      return false;
    }
  ...
  public static void main(String... args) {
    ...
    if (server) {
      ...
      mLog.print("Setting up NetworkTables client for team " + team);
